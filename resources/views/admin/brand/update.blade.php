...
<form id="" action="{{url('brand_update')}}" method ="post"  enctype="multipart/form-data">  
  @csrf
  <div class="col-md-6 offset-md-3 mt-3 jumbotron">
    <h4 class="text-center mb-3">Update Brand</h4>    
   ...
   <div class="form-group">
    ...
    <img src="{{asset('brand_img/'.$result->image)}}" alt="image" width="100px" height="100px">
